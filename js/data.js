 ...
 * data.js
 * ---------------------------------------------------------------------------
 * منوی اصلی دیگه اینجا نیست — منو از یه گوگل‌شیت زنده خونده میشه
 * (js/sheetMenu.js + js/config.js). این فایل فقط دو چیز داره:
 *
 *   1. ICONS — آیکون‌های آماده‌ی هر دسته. اینا چیزی نیستن که صاحب کافه لازم
 *      باشه عوض کنه، پس همینجا توی کد می‌مونن. کلید هر آیکون رو توی ستون
 *      category_icon گوگل‌شیت (یا فیلد icon هر دسته) استفاده می‌کنیم.
 *
 *   2. DEFAULT_MENU — منوی واقعی فعلی کافه، به‌عنوان «نسخه‌ی پشتیبان».
 *      اگه به هر دلیلی گوگل‌شیت در دسترس نبود (اینترنت قطع بود، لینک هنوز
 *      توی js/config.js تنظیم نشده، یا شیت پابلیش نشده)، سایت به‌جای نشون‌دادن
 *      صفحه‌ی خالی، همین منو رو نشون میده. بعد از راه‌اندازی گوگل‌شیت، منبع
 *      اصلی خودِ شیت میشه و این فقط پشتیبانه — لازم نیست دیگه بهش دست بزنی.
 * ---------------------------------------------------------------------------
 */
...
export const DEFAULT_MENU = [
  {
    id: 'herbal', title: 'چای و دمنوش', subtitle: 'گرم و آرام‌بخش', icon: 'herbal',
    items: [
  ...
  {
    id: 'smoothie', title: 'اسموتی', subtitle: 'میوه‌ای و سرد', icon: 'cold',
    items: [
  ...
  {
    id: 'dessert', title: 'کیک و دسر', subtitle: 'همراه فنجان بعدی‌تان', icon: 'dessert',
    items: [
  ...
  {
    id: 'shake', title: 'شیک', subtitle: 'خامه‌ای و خوشمزه', icon: 'cold',
    items: [
  ...
  {
    id: 'mocktail', title: 'موکتل', subtitle: 'تازه و رنگی', icon: 'cold',
    items: [
  ...
  {
    id: 'coffee-hot', title: 'نوشیدنی گرم بر پایه قهوه', subtitle: 'دم‌آوری تازه، هر فنجان', icon: 'coffee',
    items: [
  ...
  {
    id: 'coffee-brew', title: 'قهوه دمی', subtitle: 'روش‌های سنتی', icon: 'coffee',
    items: [
  ...
  {
    id: 'coffee-cold', title: 'نوشیدنی سرد بر پایه قهوه', subtitle: 'خنک و انرژی‌بخش', icon: 'cold',
    items: [
  ...
  {
    id: 'milk-hot', title: 'نوشیدنی گرم بر پایه شیر', subtitle: 'نرم و گرم', icon: 'coffee',
    items: [
  ...
  {
    id: 'sandwich', title: 'ساندویچ', subtitle: 'سیر و خوشمزه', icon: 'breakfast',
    items: [
  ...
  {
    id: 'burger', title: 'برگرها', subtitle: 'تازه و داغ', icon: 'breakfast',
    items: [
  ...
  {
    id: 'pizza', title: 'پیتزا', subtitle: 'تازه از فر', icon: 'breakfast',
    items: [
  ...
  {
    id: 'appetizer', title: 'پیش غذا', subtitle: 'شروع خوب', icon: 'breakfast',
    items: [
  ...
  {
    id: 'hookah', title: 'قلیان', subtitle: 'طعم‌های مختلف', icon: 'default',
    items: [
